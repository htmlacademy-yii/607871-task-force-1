...
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li class="menu-toggle__item menu-toggle__item--completed <?= ($status === 'completed') ? ' menu_toggle__item--current' : ''; ?>">
        ...
        <li class="menu-toggle__item menu-toggle__item--new<?= ($status === 'new' || !isset($status)) ? ' menu_toggle__item--current' : ''; ?>">
            <div class="menu-toggle__svg-wrapper">
        ...
        <li class="menu-toggle__item menu-toggle__item--active<?= ($status === 'active') ? ' menu_toggle__item--current' : ''; ?>">
            <div class="menu-toggle__svg-wrapper">
        ...
        <li class="menu-toggle__item menu-toggle__item--canceled<?= ($status === 'canceled') ? ' menu_toggle__item--current' : ''; ?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <li class="menu-toggle__item menu-toggle__item--hidden <?= ($status === 'hidden') ? ' menu_toggle__item--current' : ''; ?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="new-task__card">
                <div class="new-task__title">
                    <a href="<?= Url::to("/task/view/{$myTask->id}"); ?>" class="link-regular">
                        <h2><?= Html::encode($myTask->title); ?></h2>
                    </a>
