        ...
        <div class="content-view__feedback-card user__search-wrapper">
            <div class="feedback-card__top">
                <div class="user__search-icon">
                    <a href="/user.html"><img src="<?= $user->profile->avatar; ?>" width="65" height="65"></a>
                ...
                <span class="new-task__time">Был на сайте <?= DateFormatter::getRelativeTime($user->last_visit_date); ?></span>
            </div>
